...
HD_PWD='C:/Users/fbadi/OneDrive/Documents/taller_digital/lab5-grupo_04_2021_s2_lab5/Pruebas/prueba_ram/prueba_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopRAM.tcl
