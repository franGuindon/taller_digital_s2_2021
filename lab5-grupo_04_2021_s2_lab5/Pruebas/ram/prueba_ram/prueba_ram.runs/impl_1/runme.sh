...
HD_PWD='C:/Users/fbadi/OneDrive/Documents/taller_digital/lab5-grupo_04_2021_s2_lab5/Pruebas/prueba_ram/prueba_ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopRAM.tcl -notrace
