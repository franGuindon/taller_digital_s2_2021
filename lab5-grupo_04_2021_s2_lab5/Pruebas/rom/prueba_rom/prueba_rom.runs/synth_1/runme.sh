...
HD_PWD='C:/Users/fbadi/OneDrive/Documents/taller_digital/lab5-grupo_04_2021_s2_lab5/Pruebas/rom/prueba_rom/prueba_rom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopROM.tcl
